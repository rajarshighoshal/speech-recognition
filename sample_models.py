...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    rnn_input_for_next_rnn = BatchNormalization(name='bn_1')(rnn_1)
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bidir_rnn_1 = Bidirectional(GRU(units, activation="relu",return_sequences=True, 
                 implementation=2, name="bd_rnn_1"))(bn_cnn)
    bidir_rnn_input_for_next_rnn = BatchNormalization(name='bn_1')(bidir_rnn_1)
    for layer in range(recur_layers - 1):
        layer_name = "bidir_rnn_" +  str(layer+2)
        bidir_rnn = GRU(units, activation="relu",return_sequences=True, 
                 implementation=2, name=layer_name)(bidir_rnn_input_for_next_rnn)
        batchnorm_name = "bn_" + str(layer)
        bidir_rnn_out = BatchNormalization(name=batchnorm_name)(bidir_rnn)
        bidir_rnn_input_for_next_rnn = bidir_rnn_out
    # Add a TimeDistributed(Dense(output_dim)) layer
    time_dense = TimeDistributed(Dense(output_dim))(bidir_rnn_out)
